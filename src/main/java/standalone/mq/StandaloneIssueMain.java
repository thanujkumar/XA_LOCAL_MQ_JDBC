...
/**
 * Not setting  CachecConsumer to false, open count goes on increasing when looked at MQ Browser
 * https://dzone.com/articles/spring-and-caching-jms
 * @author thanujkumar_sc
 *
 */
public class StandaloneIssueMain {
...
//	}
	...
	public static void main(String[] args) throws Exception{
		...
		StandaloneIssueMain m = new StandaloneIssueMain();
